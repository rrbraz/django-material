...
from .. import test_widget_textarea as test
from . import VisualTest


@override_settings(ROOT_URLCONF='tests.test_widget_textarea')
class Test(VisualTest):
    def test_test_default_usecase(self):
        ...
        self.assertScreenshot('form', 'textarea_default_usecase')
