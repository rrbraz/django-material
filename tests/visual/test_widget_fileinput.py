...
@override_settings(ROOT_URLCONF='tests.test_widget_fileinput')
class Test(VisualTest):
    def test_test_default_usecase(self):
        ...
        self.assertScreenshot('form', 'fileinput_default_usecase')
    ...
    def test_part_errors(self):
        ...
        self.assertScreenshot('form', 'fileinput_part_errors')
